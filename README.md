...
| 3    | 23-Sep | Sequences (Lists & Tuples) | Hetland CH02 / [slides_2](https://github.com/mageed/libr559cWI2018/blob/master/slides/unit_two.ipynb)  & [slides_3](https://github.com/UBC-NLP/python2020/blob/master/slides/unit_three.ipynb); ```Videos:``` [strings_0](https://youtu.be/Tk7yys4dHJE); [lists_tuples](https://youtu.be/5ESL6O_lfPg) |                            |
